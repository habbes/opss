...
$routes = [
		...
		['^invitation\-declined\/?$', "EmailInvitationDeclined"],
		['^papers\/all\/?$', "Papers"],
		['^papers\/?$', "Papers"],
		...
		['^papers\/(\w+)\/workshop\-reviews\/?$', "papers/WorkshopReviews"],
		['^papers\/(\w+)\/workshop\-reviews\/(\d+)\/?$', "papers/WorkshopReviews"],
		['^papers\/(\w+)\/workshop\-reviews\/(\d+)\/file?$', "papers/WorkshopReviews@downloadFile"],
		...
		['^reviewers\/search?$', 'Users@searchReviewers'],
